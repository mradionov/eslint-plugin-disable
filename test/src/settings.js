...
test('default settings for falsy config', function (t) {
  t.plan(2);
...
test('default settings for undefined settings', function (t) {
  t.plan(2);
...
test('default settings for undefined plugin settings', function (t) {
  t.plan(2);
...
test('default settings for empty plugin settings', function (t) {
  t.plan(2);
...
test('convert to array single string path', function (t) {
  var res = settings.prepare(plugin({ paths: {
    'foo': '/foo/1'
  }}));
  t.deepEqual(res.paths, [
